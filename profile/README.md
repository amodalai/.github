...
**The agent runtime platform.** Configure AI agents with a git repo of markdown and JSON. Connect any system, write a skill, deploy.
...
- **Marketing** — campaign analysis, lead scoring, content performance
